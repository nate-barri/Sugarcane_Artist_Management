    ...
    <div className="flex min-h-screen bg-gray-100 text-gray-800">
      ...
      <main className="flex-1 p-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-start">
            <h2 className="text-lg font-medium text-gray-600 mb-2">Subscribers Growth</h2>
            <p className="text-3xl font-bold text-gray-900">0%</p>
          </div>
        </section>

        {/* Charts Section for YouTube */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Audience Retention</h2>
            <div className="flex justify-center items-center h-48 bg-gray-50 rounded-lg">
              <img
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Subscribers Growth</h2>
            <div className="flex justify-center items-center h-48 bg-gray-50 rounded-lg">
              <img
                src="https://placehold.co/250x150/fca5a5/ffffff?text=Line+Chart"
